...
const TAB_ITEMS = ["tickets", "mission", "contact", "donate"] as const;
...
const Landing = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center h-screen 2xl:w-[30vw] mt-2 ">
        <div className="flex items-center w-full px-2">
          {(isMobileSm || isMobileLg) && <HamburgerMenu onNavigate={handleNav} />}
          <img
            className={`max-mobile:h-[5vh] md:h-[5vh] ${isMobileSm || isMobileLg ? "w-[75vw] ml-2" : "w-[85vw]"}`}
            src={MOTHERSHIP}
          />
        </div>
        ...
        {/*CONTENT SECTION */}
        <main className="relative bg-[#2cb0d8] w-screen md:w-[65vw] 2xl:w-[30vw] h-full 2xl:h-[64.5vh] flex flex-col justify-between overflow-hidden z-30 -mt-1">
          {/* Mission statement overlaps heroes */}
          <div className="relative z-20 bg-pink-300/80 p-4 md:w-[55vw] 2xl:w-[25vw] md:h-[75vh] 2xl:h-[35vh] self-center mt-4 overflow-y-auto">
